...
export default function Loader({ isVisible }) {
    ...
    return (
        <div className={`flex-col gap-4 w-full h-dvh fixed inset-0 bg-white z-50 flex items-center justify-center transition-opacity duration-500  ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
            <div
